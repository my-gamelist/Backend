...
class Database:
    ...
    def add_game(self, app_id, game_name, release_date, rating, num_reviews, description, studio, publisher):
        query = "INSERT INTO game (app_id, game_name, release_date, rating, num_reviews, description, developers, publishers) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"     
        self.cursor.execute(query, (app_id, game_name, release_date, rating, num_reviews, description, studio, publisher))
